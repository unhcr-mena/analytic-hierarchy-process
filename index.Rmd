...
## 4.  Run AHP algorithm
- Calculation done using [R statistical language](https://rpubs.com/gluc/ahp). Note some [proprietary software](https://en.slideshare.net/TransparentChoice/presentations) are also available but would require a [Data Protection Impact Assessment](http://www.refworld.org/pdfid/55643c1d4.pdf#page=28) before using them.
